...
public class LeaveServlet extends HttpServlet {
	...
	//审核
	private void checkLeave(HttpServletRequest request,HttpServletResponse response) throws SQLException {
		// TODO Auto-generated method stub
	...
	private void editLeave(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		// TODO Auto-generated method stub
		LeaveDao leaveDao = new LeaveDao();
		int id = Integer.parseInt(request.getParameter("id"));
		//获取当前登录用户类型
	...
	private void addLeave(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		// TODO Auto-generated method stub
		int studentId = Integer.parseInt(request.getParameter("studentid"));
        String info = request.getParameter("info");
        Leave leave = new Leave();
